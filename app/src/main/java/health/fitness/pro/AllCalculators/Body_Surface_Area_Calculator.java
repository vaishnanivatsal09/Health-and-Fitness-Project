...
public class Body_Surface_Area_Calculator extends Activity {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.tv_search_bsa.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (Body_Surface_Area_Calculator.this.et_height.getText().toString().trim().equals("") || Body_Surface_Area_Calculator.this.et_height.getText().toString().trim().equals(".")) {
                    Body_Surface_Area_Calculator.this.et_height.setError(Body_Surface_Area_Calculator.this.getString(R.string.Enter_Height));
                } else if (Body_Surface_Area_Calculator.this.et_weight.getText().toString().trim().equals("") || Body_Surface_Area_Calculator.this.et_weight.getText().toString().trim().equals(".")) {
                    Body_Surface_Area_Calculator.this.et_weight.setError(Body_Surface_Area_Calculator.this.getString(R.string.Enter_Weight));
                } else {
                    Body_Surface_Area_Calculator.this.height_unit = Body_Surface_Area_Calculator.this.tv_heightunit.getText().toString();
                    Body_Surface_Area_Calculator.this.weight_unit = Body_Surface_Area_Calculator.this.tv_weightunit.getText().toString();
                    Body_Surface_Area_Calculator.this.inserted_weight = Float.parseFloat(Body_Surface_Area_Calculator.this.et_weight.getText().toString());
                    Body_Surface_Area_Calculator.this.inserted_height = Float.parseFloat(Body_Surface_Area_Calculator.this.et_height.getText().toString());
                    StringBuilder sb = new StringBuilder();
                    sb.append("inserted_weight");
                    sb.append(Body_Surface_Area_Calculator.this.inserted_weight);
                    Log.d("inserted_weight", sb.toString());
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("inserted_height");
                    sb2.append(Body_Surface_Area_Calculator.this.inserted_height);
                    ...
                    Body_Surface_Area_Calculator.this.calculate();
                }
            }
        });
        this.iv_back.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Body_Surface_Area_Calculator.this.onBackPressed();
            }
        });
    }
    ...
    private OnClickListener showPopupWindowHeight() {
        return new OnClickListener() {
            public void onClick(View view) {
                Body_Surface_Area_Calculator.this.popupWindowHeight().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowHeight() {
        ...
        this.listViewHeight.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                Body_Surface_Area_Calculator.this.tv_heightunit.setText((CharSequence) Body_Surface_Area_Calculator.this.arraylist_height.get(i));
                Body_Surface_Area_Calculator.this.dismissPopupHeight();
            }
        });
    ...
    private OnClickListener showPopupWindow_Weight() {
        return new OnClickListener() {
            public void onClick(View view) {
                Body_Surface_Area_Calculator.this.popupWindowWeight().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowWeight() {
        ...
        this.listViewWeight.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                sb2.append((String) Body_Surface_Area_Calculator.this.arraylist_weigth.get(i));
                Log.d("arraylist_weigth", sb2.toString());
                Body_Surface_Area_Calculator.this.tv_weightunit.setText((CharSequence) Body_Surface_Area_Calculator.this.arraylist_weigth.get(i));
                Body_Surface_Area_Calculator.this.dismissPopupTopics();
            }
        });
